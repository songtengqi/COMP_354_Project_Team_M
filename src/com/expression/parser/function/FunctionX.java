			...
			if (character >= '0' && character <= '9') {
				...
				if (hasFunction) {
					if (Constants.SIN.equals(function)) {
						...
						value = Functions.sinh(eval(new_f_x, xi));
						...
						final Double baseNum = new Double(base);
						final Double expNum = new Double(exponent);
						try {
							value = Functions.log(expNum.doubleValue(), baseNum.doubleValue());
						}
